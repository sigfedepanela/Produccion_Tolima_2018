...
var style_ProduccindePanelaToneladas_2 = function(feature, resolution){
    ...
    if (value >= 32.780000 && value <= 683.040000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 683.040000 && value <= 1921.050000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 1921.050000 && value <= 2992.120000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 2992.120000 && value <= 6231.990000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 6231.990000 && value <= 10337.090000) {
            style = [ new ol.style.Style({
